...
# // Banner
echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ ${BGCOLOR}  WELCOME TO AUTOSCRIPT                 ${BIBlue} │${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo ""
sleep 4
clear
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/mymaswayvpn/Dotnot/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/mymaswayvpn/tutud/main/ip"
# USERNAME
rm -f /usr/bin/user
...
function noobzvpn(){
clear
wget --no-check-certificate https://raw.githubusercontent.com/mymaswayvpn/Dotnot/main/noobzvpns.zip
unzip noobzvpns.zip
cd noobzvpns
bash install.sh
rm noobzvpns.zip
...
cd
    ...
    wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/mymaswayvpn/Dotnot/main/encrypt/encrypt" ; chmod +x /usr/bin/enc
...
SHELL=/bin/sh
PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin
*/15 * * * * root /usr/local/sbin/xraylimit
END
